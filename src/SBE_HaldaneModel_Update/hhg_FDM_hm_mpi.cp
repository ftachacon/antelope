    ...
    for( j = jstart; j < jend; j++ )
    {
        ...
        for( i = 0; i < g.N[0] ; i++ )
        {
            ...
            for( ktime = 0; ktime<fpulse.NewNt-1; ktime++ )
            {
                ...
                }//End loop of evaluation of KR2 vars.
                //#####################################
                ...
                //###############################################################
                //Coherence of the occupations via Runge-Kutta 2th order (RK2)
                ...
                //RK2 Formula
                rkutta_pi[ktime+1] = rkutta_pi[ktime] + dt * k_pi[1];
                ...
                rkutta_nc[ktime+1] = rkutta_nc[ktime] + dt*k_nc[1];
