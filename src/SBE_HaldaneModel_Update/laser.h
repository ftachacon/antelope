...
void laser::elaser( double *t )
{
    ...
    a_ef0 = complex( E0x[0]*cos( (*t)* w0[0] - cep0[0] ), E0y[0]*sin( (*t)* w0[0] - cep0[0] ) )*exp( -.5* ( *t )*( *t )/width/width )   -a_ef1;
...
void laser::avlaser( double *t )
{
    ...
    a_af0 =  complex( -E0x[0]*sin( (*t)* w0[0] - cep0[0] ), E0y[0]*cos( (*t)* w0[0] - cep0[0] ) )*exp( -.5* ( *t )*( *t )/width/width )/w0[0]-a_af1;
    //E0x
