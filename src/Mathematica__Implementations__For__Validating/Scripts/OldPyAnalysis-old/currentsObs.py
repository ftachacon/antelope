...
def haldane_model_params( _a0, _t1
                              ,_t2
                              ,_phi0
                              ,_M0
                         ,_eps):
...
def occupation_vis(time,kx,occupationCB_nc,fparams,oparams):
...
#    void bases_vectors( );
#    void B0( double *kx, double *ky );
#    void B1( double *kx, double *ky );
#    void B2( double *kx, double *ky );
#    void B3( double *kx, double *ky );
#    void BNorm( double *kx, double *ky );
#
#
#
#
#
#    void xgradB0( double *kx, double *ky );
#    void xgradB1( double *kx, double *ky );
#    void xgradB2( double *kx, double *ky );
#    void xgradB3( double *kx, double *ky );
#    void xgradBNorm( );
#
#
#
#    void ygradB0( double *kx, double *ky );
#    void ygradB1( double *kx, double *ky, double *res );
#    void ygradB2( double *kx, double *ky, double *res );
#    void ygradB3( double *kx, double *ky, double *res );
#    void ygradBNorm( double *res );
#
#
#
#    //Bloch Angle Sphere
#    void phiBloch(   double *res );
#    void thetaBloch( double *res );
#
#
#
#    void ygrad_phiBloch(  double *res );
#    void ygrad_rphiBloch( double *res );
#
#
#
#    void xgrad_phiBloch(  double *res );
#    void xgrad_rphiBloch( double *res );
#
#
#
#    void xgrad_thetaBloch(  double *res );
#    void xgrad_rthetaBloch( double *res );
#
#
#
#    void ygrad_thetaBloch(  double *res );
#    void ygrad_rthetaBloch( double *res );
#
#
#
#    void xBerryConnectionC( double *res );
#    void xBerryConnectionV( double *res );
#
#
#
#    void yBerryConnectionC( double *res );
#    void yBerryConnectionV( double *res );
#
#
#
#    void Ec( );
...
#
#    void anomalous_velV( complex efield, double zBCurva_v0 );
#    void anomalous_velC( complex efield, double zBCurva_c0 );
#
#
#    /*
#
