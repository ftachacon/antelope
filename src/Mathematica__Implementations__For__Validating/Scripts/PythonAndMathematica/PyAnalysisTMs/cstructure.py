...
###############################
## MOMENTUM AXIS
Nx      = 1*300+1;#301;#251;          #101;#51            #251;          #51;   #250
Ny      = 100;          #100;  #101

xkmax   = 1*1.918999727359802;
ykmax   = 1*1.107935009166000;
...
################################
## TIME STEPS
dt      = 2*1.401970981235;#1.40249672035258;
#2.804993440705173;#1.401970981235;#     #1.401970981234623283439
Ntime   = 3200;#2560;#5120#             #3585#5121;#                 #2560;             #
