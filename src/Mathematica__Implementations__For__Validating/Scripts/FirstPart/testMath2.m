...
(***********************************************)
(******* TIME STEP *******)
dt          = 1.50;(*T00/160.0/2.50;*)        (*Time step, T00/160.06/2.;*)
tmax        = 3.0*alpha0;(*2.0*alpha0;*)
...
regular     = t1*10^-14;        (*Regularization of Dipole*)
regular1    = t1*10^-14;        (*t1/30/1000.;*)
...
Dipole := Function[{kx, ky, qeps}
                   ...
                   (*RDipoleCV[kx, ky, regular1]
                   + I*IDipoleCV[kx, ky, qeps]
                   *)
...
solver = Function[ky,
            ...
            NDSolve[
                            ...
                            D[pi[kx, t], t] - Ef[t] * D[pi[kx, t], kx] ==
                                -I ( Eg[kx, ky]  + (*Ef[t]*Chig[kx, ky, creg][[dir]]*)
                                    -  I/T2 )*pi[kx, t]
                            ...
                            D[nc[kx, t], t] - Ef[t] * D[nc[kx, t], kx] ==-2.*Im[ Conjugate[ROmega[kx, ky, t]] * pi[kx, t] ]
                                
                                (*              -I*Conjugate[ROmega[kx, ky, t]] * pi[kx, t]
                                              +I*ROmega[kx, ky, t] * Conjugate[pi[kx, t]]
                                  *)
                            ...
                            (*, (D[pi[kx, t],kx]/.kx->kxMin) == (D[pi[kx, t],kx]/.kx->kxMax)
                              *)
                            ...
                            (*,(D[nc[kx, t],kx]/.kx->kxMin) == (D[nc[kx, t],kx]/.kx->kxMax)
                            *)
                            ...
                            , MaxStepSize-> {{dkx/10.,dkx},{dt/10.,dt}}
