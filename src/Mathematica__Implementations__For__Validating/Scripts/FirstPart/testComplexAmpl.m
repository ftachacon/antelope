...
Nkx     = 301;  (*301;251,151,101,This controls the momentum grid steps*)
Nky     = 100;
...
solver = Function[ky,
            ...
            NDSolve[
                            ...
                            D[pi[kx, t], t] - Ef[t]* D[pi[kx, t], kx] ==
                                -I ( Eg[kx, ky] + Ef[t]*Chig[kx, ky, creg][[dir]] -  I/T2)* pi[kx, t]
