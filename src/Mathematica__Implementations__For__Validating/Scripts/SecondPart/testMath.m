...
CodeDeveloping/March19_2019/chernNo0/";
...
Af := Function[{t, w0, e0, alpha}, -e0/w0 Sin[w0 t] Exp[-2 (t/alpha)^2]];
...
nB1 = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by}
               , B1[kx, ky, t1, ax, ay]/BNorm[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]
               ];


nB2 = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by}
               , B2[kx, ky, t1, ax, ay]/BNorm[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]
               ];
...
PhiGrad = Function[{kx, ky, t1, ax, ay, qeps},
                   (B2Grad[kx, ky, t1, ax, ay] B1[kx, ky, t1, ax, ay] -
                    B1Grad[kx, ky, t1, ax, ay]  B2[kx, ky, t1, ax, ay]) /(B1[kx, ky, t1, ax,
                                                                             ay]^2 + B2[kx, ky, t1, ax, ay]^2 + qeps)
                   ]  ;



ThetaGrad =
Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by,
    qeps}, -(B3Grad[kx, ky, t2, M, \[Phi], bx, by] *
             BNorm[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by] -
             BNormGrad[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by] *
             B3[kx, ky, t2, M, \[Phi], bx, by]) /(Sqrt[
                                                       BNorm[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]^2 -
                                                       B3[kx, ky, t2, M, \[Phi], bx, by]^2 ] + qeps)/(BNorm [kx, ky, t1, t2,
                                                                                                             M, \[Phi], ax, ay, bx, by] + qeps)
         ]  ;
...
cGroupVel = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by}
                     , Grad[Ec[kkx, kky, t1, t2, M, \[Phi], ax, ay, bx, by], {kkx, kky}] /.
                     kkx -> kx /. kky -> ky
                     ];
...
vGroupVel = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by},
                     Grad[Ev[kkx, kky, t1, t2, M, \[Phi], ax, ay, bx, by], {kkx, kky}] /.
                     kkx -> kx /. kky -> ky
                     ];
...
uCond = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by}
                 ,
                 {
                     Exp[-I*Phi[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2] Cos[
                                                                                  Theta[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2]
                     ,
                     Exp[I*Phi[kx, ky, t1, t2, M, \[Phi], ax, ay]/2] Sin[
                                                                         Theta[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2]
                 }
                 ];
...
uVal = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by}
                ,
                {
                    Exp[-I*Phi[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2] Sin[
                                                                                 Theta[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2]
                    ,
                    -Exp[I*Phi[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2] Cos[
                                                                                 Theta[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]/2]
...
BerryConnectionReg = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by, qeps}
                              ,
...
cBerryCurvatureNew = Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by, qeps}
                              ,
                              -1/2 Sin[Theta[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by]]
                              *Cross[
                                     
                                     { ThetaGrad[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by, qeps][[1]]
...
CrossDipole := Function[{kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by, qeps}
                        , Abs[
                              Conjugate[
...
Chig = Function [
                 ...
                 2 BerryConnectionReg[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by, creg]
                 ];




(*Definition of Momentum Axis and finite difference derivative under  periodic boundary conditions
*)
(* Momentum axis *)
momaxis := Function[
                    {NkVar, kminVar},
...
(* Energy Band Gap*)
 ...
 Print["\n***********************************\nEnergy band gap, Eg   =     ", N[Min[Tac - Tav],16]*efac, ";\nMax gap      =           ",
       N[Max[Tac - Tav]*efac,16], "     eV"]
 ...
 CherNo[t1_, t2_, M_, \[Phi]_, ax_, ay_, bx_,
        by_] := -NIntegrate[
                            cBerryCurvature[kx, ky, t1, t2, M, \[Phi], ax, ay, bx, by][[
