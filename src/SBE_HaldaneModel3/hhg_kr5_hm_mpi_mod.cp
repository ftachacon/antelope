...
int main( int argc, char *argv[] )
{
    ...
    gauge_ky_down  = gbox_ky_down;//0.01;
    gauge_ky_up    = gbox_ky_up;//0.70;
...
/*
    ...
    if ( Nprocessors !=1 & points_per_core%2 != 0)
    {
        
        cout << "\n\nThe fraction Ny / (No.-Cores-Or-MPI-Ranks) is: " << points_per_core << " but, it has to be an exact integer.\nThe program exit";
        exit(0);
