...
xaxmax      = 30;   # controling harmonic-order axis limits, u


plt.xlim(xaxmin, xaxmax);
plt.ylim(yaxmin, yaxmax);

fname='/'+str(mparam)+'ZoomHarmonicSpectrumCNo'+ str("%.1f"%ChernNo) + 'M_' + str("%.2f"%M0) + 'Phi_' + str("%.2f"%Phi0) + '.png'
