...
int main( int argc, char *argv[] )
{
    ...
    string IntionMethod = "Simpson";//       // "Trapz" or "Simpson" or "NoneTrapz"/"NoneSimpson"
    ...
    complex *pmatrix[Ngrad];
    double *gvelocity_c[Ngrad];
    double *gvelocity_v[Ngrad];
    double *edispersion;
    ...
    {        
        ...
        setting_complex_memory( &pmatrix[itemp], NTotal);
        setting_double_memory( &gvelocity_c[itemp], NTotal);
        setting_double_memory( &gvelocity_v[itemp], NTotal);
        
    }
    setting_double_memory( &edispersion, NTotal);
    ...
    for (jtemp=0; jtemp < g.N[1];++jtemp)
    {
      ...
      pmatrix[0][kindex] = cs.velocity_cv0[0];
	  pmatrix[1][kindex] = cs.velocity_cv0[1];

	  gvelocity_c[0][kindex] = cs.group_c0[0];
	  gvelocity_c[1][kindex] = cs.group_c0[1];
	  gvelocity_v[0][kindex] = cs.group_v0[0];
	  gvelocity_v[1][kindex] = cs.group_v0[1];

	  edispersion[kindex] = cs.eg0;
      }
    }
    ...
    {            
        ...
        for( itemp = 0; itemp < g.N[0] ; itemp++ )
        {
            ...
            teg5[ 0 ]        = edispersion[kindex];
	        tavg5[0]         = (gvelocity_c[0][kindex] - gvelocity_v[0][kindex]) * real(taf5[0])  + (gvelocity_c[1][kindex] - gvelocity_v[1][kindex]) * imag(taf5[0]);
	        tapcv5[0]        = pmatrix[0][kindex] * real(taf5[0]) + pmatrix[1][kindex] * imag(taf5[0]);
            ...
            group_velocity_v[0] =  gvelocity_v[0][kindex]  * nv * g.weight[ g.index(  &itemp, &jtemp, &ktemp ) ];
            group_velocity_v[1] =  gvelocity_v[1][kindex]  * nv * g.weight[ g.index(  &itemp, &jtemp, &ktemp ) ];
            ...
            group_velocity_c[0] =  gvelocity_c[0][kindex]  * rkutta_nc[ g.index( &itemp, &jtemp, &ktemp ) ]  * g.weight[ g.index(  &itemp, &jtemp, &ktemp ) ];
            group_velocity_c[1] =  gvelocity_c[1][kindex]  * rkutta_nc[ g.index( &itemp, &jtemp, &ktemp ) ]  * g.weight[ g.index(  &itemp, &jtemp, &ktemp ) ];
            ...
            teg5[ ltemp ]        = edispersion[kindex];
	        tavg5[ ltemp ]         = (gvelocity_c[0][kindex] - gvelocity_v[0][kindex]) * real(taf5[ltemp])  + (gvelocity_c[1][kindex] - gvelocity_v[1][kindex]) * imag(taf5[ltemp]);
	        tapcv5[ ltemp ]        = pmatrix[0][kindex] * real(taf5[ltemp]) + pmatrix[1][kindex] * imag(taf5[ltemp]);
            ...
            der_pi( &teg5[0], &tavg5[0], &cs.T2, &tapcv5[0], &temp_pi5[0], &temp_nc5[0], &k_pi5[0] );
            der_nc2( &tapcv5[0], &temp_pi5[0], &cs.T1, &temp_nc5[0], &k_nc5[0] );
            ...
            der_pi( &teg5[1], &tavg5[1], &cs.T2, &tapcv5[1], &temp_pi5[1], &temp_nc5[1], &k_pi5[1] );
            der_nc2( &tapcv5[1], &temp_pi5[1], &cs.T1, &temp_nc5[1], &k_nc5[1] );
            ...
            der_pi( &teg5[2], &tavg5[2], &cs.T2, &tapcv5[2], &temp_pi5[2], &temp_nc5[2], &k_pi5[2] );
            der_nc2( &tapcv5[2], &temp_pi5[2], &cs.T1, &temp_nc5[2], &k_nc5[2] );
            ...
            der_pi( &teg5[3], &tavg5[3], &cs.T2, &tapcv5[3], &temp_pi5[3], &temp_nc5[3], &k_pi5[3] );
            der_nc2( &tapcv5[3], &temp_pi5[3], &cs.T1, &temp_nc5[3], &k_nc5[3] );
            ...
            der_pi( &teg5[4], &tavg5[4], &cs.T2, &tapcv5[4], &temp_pi5[4], &temp_nc5[4], &k_pi5[4] );
            der_nc2( &tapcv5[4], &temp_pi5[4], &cs.T1, &temp_nc5[4], &k_nc5[4] );
            ...
            der_pi( &teg5[5], &tavg5[5], &cs.T2, &tapcv5[5], &temp_pi5[5], &temp_nc5[5], &k_pi5[5] );
            der_nc2( &tapcv5[5], &temp_pi5[5], &cs.T1, &temp_nc5[5], &k_nc5[5] );
	...
	free( pmatrix[itemp] );
	free( gvelocity_c[itemp] );
	free( gvelocity_v[itemp] );
