...
N_MPI_TASKs=1 #2   #No. of MPI task or cores for parallelization
...
Ny=1 #465   #233 #233 #117#            # No. of points along ky, ratio Nx/Ny=1.72 or, dpending on box 1.16



###############################
## Some laser field inputs ##
E0=0.003           # Electric field strength (a.u.)
Ncycles=8         # No. of Opt. cycles
#ellip=-1.0         # Ellipticity

dt=0.025             # Time-Steps (a.u.)
