...
ofname          = "/HHG__w0__" + str("%.3f"%LParams[0,2]) + "__E0__" + str("%.3f"%LParams[0,0]) + "__e0__" + str("%.3f"%LParams[0,4]) + "__" + nparam  + "__.dat"
...
fname='/'+str(mparam)+'LinearHarmonicSpectrum__'+ "w0__" + str("%.3f"%LParams[0,2]) + "__E0__" + str("%.3f"%LParams[0,0]) + "__e0__" + str("%.3f"%LParams[0,4]) + "__" + nparam  + "__.pdf"
...
fname='/'+str(mparam)+'InterIntraHarmonicSpectrum__'+ "w0__" + str("%.3f"%LParams[0,2]) + "__E0__" + str("%.3f"%LParams[0,0]) + "__e0__" + str("%.3f"%LParams[0,4]) + "__" + nparam  + "__.pdf"
...
fname='/'+str(mparam)+'CircularHarmonicSpectrum__'+ "w0__" + str("%.3f"%LParams[0,2]) + "__E0__" + str("%.3f"%LParams[0,0]) + "__e0__" + str("%.3f"%LParams[0,4]) + "__" + nparam  + "__.pdf"
