...
public:
    ...
    complex a_ef0,a_ef1;
    complex a_af0,a_af1;
    complex temp_ef0[Ngrad];    
    complex temp_av0[Ngrad];
...
void laser::Laser_Grid()   
{
    ...
    double tempMin = minus0;
    atmin = axisinitialtime/2.;
    atmax = major0/2. + alaser;    
...
inline complex laser::elaser( double const *t, LaserParam const *p1)
{
  /*
    return complex( 
	      ...
	      p1->E0x*cos( (*t)* p1->w0 - p1->cep0 - p1->phi_x ) * f_envelope( (*t), p1, false )
  ...
  temp_ef0[0] = complex( 
			  p1->E0x*cos( (-p1->twidth/2.)* p1->w0 - p1->cep0 - p1->phi_x )
                        ,
			 p1->E0y*sin( (-p1->twidth/2.) * p1->w0 - p1->cep0 - p1->phi_y)
                       )*pow( cos(  (-p1->twidth/2.)* p1->w0/2./p1->cycles0 ), 2. );
  
  

    temp_ef0[1] = 0.;
    if ( abs( *t ) <= p1->twidth/2. )
    {
        
       temp_ef0[1] = complex( 
			  p1->E0x*cos( (*t)* p1->w0 - p1->cep0 - p1->phi_x )
                        ,
			 p1->E0y*sin( (*t) * p1->w0 - p1->cep0 - p1->phi_y)
                       )*pow( cos(  (*t)* p1->w0/2./p1->cycles0 ), 2. ) - temp_ef0[0];
                    
                    //(1.-pow( sin(  (*t)* w0[0]/4./cycles0[0]/1.5 ),2.) )  ;
    }
...
inline complex laser::avlaser( double const *t, LaserParam const *p1)
{
   ...
   //*/
    ...
    temp_av0[0] =  complex(
                         ...
                         p1->E0x*(2.*(-1. + pow( p1->cycles0, 2.) )*sin(p1->cep0 - (-p1->twidth/2.) *p1->w0) + p1->cycles0*(1. +p1->cycles0)*sin( p1->cep0 + (-1. + 1./p1->cycles0)*(-p1->twidth/2.)*p1->w0) +
                                  (-1. + p1->cycles0)*p1->cycles0*sin(p1->cep0 - ((1. + p1->cycles0)*(-p1->twidth/2.)*p1->w0 )/p1->cycles0))/(4.*(-1. + p1->cycles0)*(1. + p1->cycles0)*p1->w0)
                         
                         ,
                         
                         p1->E0y*(2.*(-1. + pow(p1->cycles0,2.))*cos(p1->cep0 - (-p1->twidth/2.)*p1->w0) + p1->cycles0*( 1. + p1->cycles0)*cos(p1->cep0 + (-1. + 1./p1->cycles0)*(-p1->twidth/2.)*p1->w0) +
                                   (-1. + p1->cycles0)*p1->cycles0*cos(p1->cep0 - ((1. + p1->cycles0)*(-p1->twidth/2.)*p1->w0)/p1->cycles0))/(4.*(-1. + p1->cycles0)*(1. + p1->cycles0)*p1->w0                                                                                                                          )
                         ) ;   
   ...
   temp_av0[1]=0.;
    if ( abs(*t) <= p1->twidth/2. )
    {
        ...
        temp_av0[1] =  complex(
                         ...
                         p1->E0x*(2.*(-1. + pow( p1->cycles0, 2.) )*sin(p1->cep0 - (*t)*p1->w0) + p1->cycles0*(1. +p1->cycles0)*sin( p1->cep0 + (-1. + 1./p1->cycles0)*(*t)*p1->w0) +
                                  (-1. + p1->cycles0)*p1->cycles0*sin(p1->cep0 - ((1. + p1->cycles0)*(*t)*p1->w0 )/p1->cycles0))/(4.*(-1. + p1->cycles0)*(1. + p1->cycles0)*p1->w0)
                         
                         ,
                         
                         p1->E0y*(2.*(-1. + pow(p1->cycles0,2.))*cos(p1->cep0 - (*t)*p1->w0) + p1->cycles0*( 1. + p1->cycles0)*cos(p1->cep0 + (-1. + 1./p1->cycles0)*(*t)*p1->w0) +
                                   (-1. + p1->cycles0)*p1->cycles0*cos(p1->cep0 - ((1. + p1->cycles0)*(*t)*p1->w0)/p1->cycles0))/(4.*(-1. + p1->cycles0)*(1. + p1->cycles0)*p1->w0                                                                                                                          )
                         ) - temp_av0[0];
     }
