...
if iparam=='Trivial':
    fname = 'IntraHHG__AND__MAP__LinearPol__Trivial.png'
else:
    fname = 'IntraHHG__AND__MAP__LinearPol__Topological.png'
filename1           =   fname;
...
if iparam=='Trivial':
    fname = 'InterHHG__AND__MAP__LinearPol__Trivial.png'
else:
    fname = 'InterHHG__AND__MAP__LinearPol__Topological.png'
filename1           =   fname;
fileNamePicture     =   filename1;
plt.savefig(fileNamePicture, dpi = 150);
